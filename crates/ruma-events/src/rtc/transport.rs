//! Types describing the RTC transports used in MatrixRTC events ([MSC4143]).
//!
...
///
/// This describes how to reach a participant's media, e.g. the LiveKit SFU to connect to.
