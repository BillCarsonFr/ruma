...
mod tests {
    ...
    use ruma_events::{
        EmptyStateKey, MessageLikeEventType, room::name::RoomNameEventContent,
    ...
    fn test_send_state_serialize() {
        ...
        let req = crate::state::send_state_event::v3::Request::new(
    ...
    fn test_send_sticky_state_serialize() {
        ...
        // This used to panic in make_endpoint_url because of a mismatch in the path parameter count
        let mut req = crate::state::send_state_event::v3::Request::new(
            owned_room_id!("!room:server.tld"),
            &EmptyStateKey,
            &RoomNameEventContent::new("Test room".to_owned()),
        )
